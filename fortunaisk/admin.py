...
class RaffleTicketAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'character', 'price_isk', 'purchase_date')  # 'character' est une @property

@admin.register(RaffleWinner)
class RaffleWinnerAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'main_character', 'total_pot', 'draw_date')  # 'main_character' est une @property
